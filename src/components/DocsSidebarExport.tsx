...
import { Grid, PlusSquare, Layout, ExternalLink, ChevronRight, ChevronDown, X, Type, Loader, Minus, Minimize2 } from "@deemlol/next-icons";
...
const ICON_MAP = {
	...
	Minus: <Minus color="#fafafa" size={16} />,
	Minimize2: <Minimize2 color="#fafafa" size={16} />,
