						...
						<AnimatePresence>
							{isMobileMenuOpen && (
								<motion.div
									...
									className="pointer-events-auto absolute top-[calc(100%+6px)] right-0 left-0 w-full overflow-hidden rounded-3xl border border-[#fafafa]/10 bg-[#000000]/40 backdrop-blur-lg md:hidden"
								>
